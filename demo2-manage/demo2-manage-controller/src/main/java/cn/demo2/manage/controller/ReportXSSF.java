...
/**POI XSSFWorkbook生成报表
 * Created by admin on 2017/7/26.
 */
public class ReportXSSF {
    public static void PoiWriteExcel(List<Item> itemList, String fullPath, OutputStream os){
        ...
        try {
            ...
            XSSFSheet sheet = workbook.createSheet("item"+sheetNum); //创建一个工作簿
            ...
            //第二行开始写入数据
            XSSFCellStyle bodyCellStyle = createBodyCellStyle(workbook);
            XSSFCellStyle dateBodyCellStyle = createDateBodyCellStyle(workbook);
     ...
     * @return
     */
    public static XSSFCellStyle createDateBodyCellStyle(XSSFWorkbook workbook){
        XSSFCellStyle cellStyle = workbook.createCellStyle();
        XSSFFont font = workbook.createFont();
        font.setFontHeightInPoints((short) 8);
        font.setFontName(XSSFFont.DEFAULT_FONT_NAME);
     ...
     * @param cellStyle
     */
    public static void writeTitleContent(XSSFSheet sheet, XSSFCellStyle cellStyle){
        XSSFRow row = null;
        XSSFCell cell = null;
        //标题
     ...
     * @param sheet
     */
    public static void setSheetColumn(XSSFSheet sheet){
